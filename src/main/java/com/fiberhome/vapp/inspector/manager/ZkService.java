 ...
 * 
 */
public interface ZkService extends ZkNodeService {
     ...
     * @param nodeListener
     */
    void addWatchers(List<String> selectedNodes, NodeListener nodeListener);

    /**
     * @param selectedNodes
     */
    void removeWatchers(List<String> selectedNodes);
