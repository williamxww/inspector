...
import com.fiberhome.vapp.inspector.manager.Pair;
...
public class ConnectionPropertiesDialog extends JDialog {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ConnectionPropertiesDialog.class);
    ...
    public ConnectionPropertiesDialog(
            ...
            final InspectorPanel zooInspectorPanel) {
        ...
        options.setLayout(
                new TableLayout(new double[] { 10, TableLayout.PREFERRED, 5, TableLayout.PREFERRED, 10 }, rows));
        int i = 0;
        ...
        buttonsPanel.setLayout(new TableLayout(new double[] { 10, TableLayout.PREFERRED, 5, TableLayout.FILL,
                TableLayout.PREFERRED, 5, TableLayout.PREFERRED, 10 }, new double[] { TableLayout.PREFERRED }));
        JButton loadPropsFileButton = new JButton("Load from file");
        loadPropsFileButton.addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent e) {
                int result = fileChooser.showOpenDialog(ConnectionPropertiesDialog.this);
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    try {
                        ...
                        LOGGER.error("An Error occirred loading connection properties from file", ex);
                        JOptionPane.showMessageDialog(ConnectionPropertiesDialog.this,
                                "An Error occirred loading connection properties from file", "Error",
